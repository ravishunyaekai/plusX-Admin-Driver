...
export const addCommunity = asyncHandler(async (req, resp) => {
    try {
        const { community_name, area_name, total_residence, chargers, kwValues } = req.body;
...
export const editCommunity = asyncHandler(async (req, resp) => {
    try {
        const { community_id, community_name, area_name, total_residence, chargers, kwValues } = req.body;
